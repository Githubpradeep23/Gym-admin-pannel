...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    var config = {
      ...
      url: 'http://ec2-35-76-120-158.ap-northeast-1.compute.amazonaws.com:8080/api/v1/adminLogin',
      headers: { 
    ...
    // const userLogin = await axios.post("http://ec2-35-76-120-158.ap-northeast-1.compute.amazonaws.com:8080/api/v1/adminLogin", {
    //   email,
    //   password,
    // }
