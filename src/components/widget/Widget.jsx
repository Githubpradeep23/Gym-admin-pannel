...
const Widget = ({ type }) => {
  ...
  const getdata = async () => {
    ...
    let res = await axios.get("http://ec2-13-233-95-74.ap-south-1.compute.amazonaws.com:8080/api/v1/getAllPaymentsRecords");
    ...
    let ress = await axios.get("http://ec2-13-233-95-74.ap-south-1.compute.amazonaws.com:8080/api/v1/getAllUsers");
    ...
    let getAllRecordResponse = await axios.get("http://ec2-13-233-95-74.ap-south-1.compute.amazonaws.com:8080/api/v1/getAllPaymentsRecords");
