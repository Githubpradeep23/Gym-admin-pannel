...
const ServiceDatatable = () => {
  ...
  const getdata = async ()=>{
    let res = await axios.get("http://ec2-13-233-95-74.ap-south-1.compute.amazonaws.com:8080/api/v1/getAllGymService");
 ...
 console.log('datas',username)
  ...
  const handleDelete = (id) => {
    ...
    var config = {
      method: 'delete',
      url: 'http://ec2-13-233-95-74.ap-south-1.compute.amazonaws.com:8080/api/v1/deleteGymSevice',
      headers: { 
