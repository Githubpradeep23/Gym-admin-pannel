...
const UserDemo = () => {
  ...
  const getdata = async ()=>{
    ...
    let res = await axios.get("http://ec2-35-76-120-158.ap-northeast-1.compute.amazonaws.com:8080/api/v1/getAllDemosBookings");
  ...
  const handleDelete = (id) => {
    ...
    var config = {
      method: 'delete',
      url: 'http://ec2-35-76-120-158.ap-northeast-1.compute.amazonaws.com:8080/api/v1//deleteDemo',
      headers: { 
