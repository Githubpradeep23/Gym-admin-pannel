...
const AddUserCoin = () => {
    ...
    const onSubmit = async (data) => {
        ...
        var data = JSON.stringify({
          ...
          var config = {
            method: 'post',
            url: 'http://ec2-43-206-107-226.ap-northeast-1.compute.amazonaws.com:8080/api/v1/addCoin',
            headers: { 
    ...
    //     let userLogin = await axios.post("http://ec2-43-206-107-226.ap-northeast-1.compute.amazonaws.com:8080/api/v1/addNewUser", {
    //         username,
    //         number,
    //         coin,
    //     });
