...
const AddUserCoin = () => {
    ...
    const onSubmit = async (data) => {
        ...
        var data = JSON.stringify({
          ...
          var config = {
            method: 'post',
            url: 'http://ec2-13-233-95-74.ap-south-1.compute.amazonaws.com:8080/api/v1/addCoin',
            headers: { 
    ...
    //     let userLogin = await axios.post("http://ec2-13-233-95-74.ap-south-1.compute.amazonaws.com:8080/api/v1/addNewUser", {
    //         username,
    //         number,
    //         coin,
    //     });
